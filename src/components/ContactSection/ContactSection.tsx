            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                ...
                <Input 
                  ...
                  className="rounded-xl py-3 px-4 bg-foreground/5 border-foreground/10 text-foreground focus-visible:ring-primary placeholder:text-muted-foreground/50 text-sm"
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full rounded-xl py-2.5 px-3.5 bg-foreground/5 border border-foreground/10 text-foreground focus:outline-none focus:ring-2 focus:ring-primary text-sm font-medium"
                >
              ...
              <div>
                ...
                <Textarea 
                  ...
                  className="rounded-xl py-3 px-4 bg-foreground/5 border-foreground/10 text-foreground focus-visible:ring-primary resize-none placeholder:text-muted-foreground/50 min-h-[90px] text-sm"
