  ...
  return (
    <section id="contact" className="max-w-7xl mx-auto px-6 py-24">
      <motion.div
        ...
        className="glass-panel p-8 md:p-12 rounded-[3rem] border border-2 border-[#0C0300]/20 dark:border-[#FFF2EF]/20 relative overflow-hidden"
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-12 md:gap-24">
          ...
          <div className="flex-1 space-y-8">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-primary/10 border border-2 border-[#0C0300]/20 dark:border-[#FFF2EF]/20 text-primary text-xs font-bold uppercase tracking-wider mb-4">
          ...
          {/* Form */}
          <div className="flex-1 glass-panel p-8 rounded-[2rem] border border-2 border-[#0C0300]/20 dark:border-[#FFF2EF]/20 relative">
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                ...
                <Input 
                  ...
                  className="rounded-xl py-3 px-4 bg-foreground/5 border-2 border-[#0C0300]/20 dark:border-[#FFF2EF]/20 text-foreground focus-visible:ring-primary placeholder:text-muted-foreground/50 text-sm"
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full rounded-xl py-2.5 px-3.5 bg-foreground/5 border border-2 border-[#0C0300]/20 dark:border-[#FFF2EF]/20 text-foreground focus:outline-none focus:ring-2 focus:ring-primary text-sm font-medium"
                >
              ...
              <div>
                ...
                <Textarea 
                  ...
                  className="rounded-xl py-3 px-4 bg-foreground/5 border-2 border-[#0C0300]/20 dark:border-[#FFF2EF]/20 text-foreground focus-visible:ring-primary resize-none placeholder:text-muted-foreground/50 min-h-[90px] text-sm"
