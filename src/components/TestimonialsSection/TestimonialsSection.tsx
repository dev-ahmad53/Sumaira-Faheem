...
const TestimonialsSection = () => {
  ...
  return (
    <section id="testimonials" className="max-w-7xl mx-auto px-6 py-24">
      ...
      >
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-primary/10 border border-2 border-[#0C0300] dark:border-[#FFF2EF]/30 text-primary text-xs font-bold uppercase tracking-wider mb-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {testimonials.map((test, i) => (
          <motion.div
            ...
            className="glass-panel p-8 rounded-3xl border border-2 border-[#0C0300] dark:border-[#FFF2EF]/30 flex flex-col relative overflow-hidden group hover:border-primary/30 transition-colors duration-500 justify-between"
          >
            {/* Subtle glow orb */}
