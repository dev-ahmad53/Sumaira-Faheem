            ...
            <>
              <motion.div
                ...
                style={{
                  ...
                  background: `linear-gradient(to bottom, #D4AF37, #C48B71, #A66E58)`,
                  boxShadow: `0 0 15px rgba(166,110,88,0.6), 0 0 25px rgba(212,175,55,0.4)`,
                }}
              />
              <motion.div
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(196,139,113,0.95) 0%, rgba(166,110,88,0.65) 40%, rgba(212,175,55,0) 70%)",
                    boxShadow:
                      "0 0 15px 4px rgba(196,139,113,0.8), 0 0 25px 8px rgba(166,110,88,0.5), 0 0 35px 12px rgba(212,175,55,0.35)",
                  }}
