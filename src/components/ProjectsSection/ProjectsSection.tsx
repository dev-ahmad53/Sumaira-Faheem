      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
        {projects.map((project, i) => (
          <motion.a
            ...
            target="_blank"
            rel="noreferrer"
            className={`group relative overflow-hidden rounded-[2.25rem] block shadow-xl border-2 border-[#2B1004]/25 dark:border-[#FFF2EF]/25 hover:border-[#2B1004] dark:hover:border-[#FFF2EF] ${project.gridClass}`}
